...
def projection_readme(
    ...
    *,
    ...
    if language == "zh":
        seven_heading = "### 过去 7 天：2026-08-15—2026-08-21"
        thirty_heading = "### 过去 30 天：2026-07-23—2026-08-21"
    else:
        seven_heading = "### Last 7 days: 2026-08-15—2026-08-21"
        thirty_heading = "### Last 30 days: 2026-07-23—2026-08-21"
...
class MemoryProjectionContractTest(unittest.TestCase):
    ...
    def test_native_timeline_rejects_acceptance_after_public_synthesis_cutoff(self):
        zh, en = valid_projection_pair()
        late = native_record("2608.90001", "2026-08-21T02:00:00Z")
    ...
    def test_periods_require_exact_windows_and_one_visible_range(self):
        ...
        records = repository_records()
        variants = {
            "wrong": zh.replace("2026-08-15—2026-08-21", "2026-08-13—2026-08-20", 1),
            "duplicate": zh.replace(
                direction_line("zh"),
                direction_line("zh") + " 2026-08-15—2026-08-21",
                1,
            ),
        }
        for name, mutated in variants.items():
