...
<details><summary><strong>2026-09-11 · MemForest</strong> · Representation → post-hoc compression <!-- timefirst:area=event-structured-posthoc-compression --> — compresses accumulated memory with EventTrees and separately adds temporal propagation at read time. <!-- timefirst:delta=event-structured-posthoc-compression --></summary>

**Question.** Can an already accumulated external-memory store be compressed without conflating representation savings with a changed retrieval policy? <!-- timefirst:question=event-structured-posthoc-compression -->

**Evidence.** With Mem0, plain MemForest at 50% compression retains 97.1% of baseline aggregate performance; at 70% it retains 93.3%, while 50%+AGPR roughly halves LoCoMo retrieval time, giving `fifty percent compression retains 97.1 percent`. <!-- timefirst:evidence=event-structured-posthoc-compression~fifty-percent-compression-retains-97.1-percent -->

**Caveat.** AGPR changes retrieval with compression, LM fusion may lose provenance/conflicts, and full repartition/merge maintenance cost is missing; `agpr changes retrieval with compression`. <!-- timefirst:caveat=event-structured-posthoc-compression~agpr-changes-retrieval-with-compression -->

**Map.** `early_signal` — Post-hoc compression is a useful systems coordinate; the combined retrieval package does not isolate EventTree causality.

**Links.** [Paper](https://arxiv.org/abs/2609.08273) · [中文深读](papers/2026/2609.08273.zh.md) · [English deep note](papers/2026/2609.08273.md) · [Code](https://github.com/Celina-love-sweet/MemForest)

</details>

<a id="entry-2609-08279"></a>
<details><summary><strong>2026-09-11 · What Eviction Destroys</strong> · Evaluation → forgetting failure localization <!-- timefirst:area=restore-counterfactual-eviction-audit --> — restores gold evidence per question to separate eviction destruction from retrieval miss and reader failure. <!-- timefirst:delta=restore-counterfactual-eviction-audit --></summary>

**Question.** When a budgeted memory answer fails, was indispensable evidence deleted, merely not retrieved, or present but unused? <!-- timefirst:question=restore-counterfactual-eviction-audit -->

**Evidence.** At top-k/80k, the irreversible share among restoration-corrected errors is 0.71 FIFO, 0.73 random, 0.67 redundancy-aware, and 0.60 LLM-importance; the matched-accuracy policy comparison is null at the reported resolution, giving `irreversible share 0.67 to 0.73`. <!-- timefirst:evidence=restore-counterfactual-eviction-audit~irreversible-share-0.67-to-0.73 -->

**Caveat.** The audit needs benchmark gold evidence and source-aligned units, while restoration changes the read context; `gold restore is a benchmark audit`. <!-- timefirst:caveat=restore-counterfactual-eviction-audit~gold-restore-is-a-benchmark-audit -->

**Map.** `early_signal` — Failure localization raises the evaluation standard without selecting a best eviction policy.

**Links.** [Paper](https://arxiv.org/abs/2609.08279) · [中文深读](papers/2026/2609.08279.zh.md) · [English deep note](papers/2026/2609.08279.md)

</details>

<a id="entry-2609-10263"></a>
<details><summary><strong>2026-09-11 · RD-Forget</strong> · Write / Update → query-conditioned use <!-- timefirst:area=query-conditioned-storage-use --> — keeps history stored while suppressing superseded state only for the current use context. <!-- timefirst:delta=query-conditioned-storage-use-separation --></summary>

**Question.** Does forgetting require deleting old memory, or can the system preserve history while changing which state is admissible for the current query? <!-- timefirst:question=query-conditioned-storage-use-separation -->

**Evidence.** Matched Luna Full scores 91.86/93.59/74.00; removing forgetting falls to 68.60/60.26/51.00, the largest deficit on all three suites, giving `matched Luna forget ablation largest deficit`. <!-- timefirst:evidence=query-conditioned-storage-use-separation~matched-Luna-forget-ablation-largest-deficit -->

**Caveat.** The archive is retained, the curator sees the question/task metadata, and lifecycle cost is incomplete; this cannot support privacy-erasure claims, so `retained archive is not physical erasure`. <!-- timefirst:caveat=query-conditioned-storage-use-separation~retained-archive-is-not-physical-erasure -->

**Map.** `early_signal` — Storage/use separation is a strong lifecycle coordinate; one paper does not establish a durable forgetting direction.

**Links.** [Paper](https://arxiv.org/abs/2609.10263) · [中文深读](papers/2026/2609.10263.zh.md) · [English deep note](papers/2026/2609.10263.md)
...
<details><summary><strong>2026-09-02 · Hindsight Memory-PRM</strong> · Auditable memory-operation credit <!-- timefirst:area=intervention-calibrated-memory-credit --> — uses retrieval, citation, and deletion-and-reanswer to turn delayed memory-operation returns into measurable local supervision. <!-- timefirst:delta=episode-outcome-reward-to-intervention-calibrated-memory-operation-credit --></summary>

**Question.** Do Write / Merge / Noop operations change later answers, or merely correlate with successful trajectories? <!-- timefirst:question=isolate-memory-operation-credit-from-episode-outcome-correlation -->

**Evidence.** Under the same scaffold, retriever, answerer, and judge, LoCoMo moves **63.4 outcome-only → 70.2 observational → 77.5 full**; the final **+7.3 points** add only intervention-calibrated flip/toxicity information, while matched-scale / shuffled-flip reach **70.6/70.5**. Deleting the **74.6%** of entries outside every read path changes accuracy by only **−0.1 points**, giving a `same scaffold intervention ladder`. <!-- timefirst:evidence=matched-credit-ladder-and-deletion-audit~same-scaffold-intervention-ladder -->

**Caveat.** Deletion measures entry-presence utility, not the ideal difference reward of the original Write/Merge action; the schema still needs domain adaptation, and offline audit is expensive (about **1.6M API calls / $1.1k** for LoCoMo and **9.8M / $6.5k** for LongMemEval), leaving `entry presence credit is not action causality`. <!-- timefirst:caveat=entry-presence-counterfactual-schema-coupling-and-high-offline-cost~entry-presence-credit-is-not-action-causality -->

**Map.** `early_signal` — one strong matched intervention raises the evidence standard for memory learning but does not establish a durable direction.

**Links.** [Paper](https://arxiv.org/abs/2608.29605) · [中文深读](papers/2026/2608.29605.zh.md) · [English deep note](papers/2026/2608.29605.md)

</details>

<a id="entry-2608-25329"></a>
<details><summary><strong>2026-08-28 · HiPS</strong> · Hierarchical personalized memory policy <!-- timefirst:area=personalized-memory-policy-evolution --> — splits memory-management policy into shared rules plus persona deltas and lets rules migrate across levels. <!-- timefirst:delta=global-memory-policy-to-shared-plus-persona-specific-policy-state --></summary>

**Question.** Does personalized memory management add user-specific policy state, or mainly benefit from backbone and bundled training differences? <!-- timefirst:question=isolate-personalized-memory-policy-state-from-backbone-and-package -->

**Evidence.** In matched PERMA ablations, full HiPS scores **66.95/56.56/63.83/56.30** versus **45.39/40.87/43.12/36.50** without Cross-Level Rule Flow; learned universal+delta rules also transfer across Qwen, GPT-4o-mini, Gemini 2.5 Flash, and GPT-5 without carrying the original RL policy, giving a `cross model universal plus delta transfer` witness. <!-- timefirst:evidence=matched-rule-flow-ablation-and-cross-model-external-policy-transfer~cross-model-universal-plus-delta-transfer -->

**Caveat.** Headline baselines do not use fully matched backbones; the package jointly changes distillation, persona gating, rule flow, selection, and policy optimization, while `full personalized policy lifecycle cost incomplete` remains the lifecycle-cost caveat. <!-- timefirst:caveat=heterogeneous-backbones-and-bundled-policy-package~full-personalized-policy-lifecycle-cost-incomplete -->

**Map.** `early_signal` — one result does not establish a durable personalized-memory-policy direction.

**Links.** [Paper](https://arxiv.org/abs/2608.25329) · [中文深读](papers/2026/2608.25329.zh.md) · [English deep note](papers/2026/2608.25329.md)

</details>

<a id="entry-2608-25553"></a>
<details><summary><strong>2026-08-28 · When Stale Constraints Go Unchecked</strong> · Budgeted stale-memory verification <!-- timefirst:area=stale-memory-verification-allocation --> — intact provenance is insufficient when scarce verification slots are allocated away from the constraint most costly to leave stale. <!-- timefirst:delta=available-provenance-to-budgeted-critical-path-verification --></summary>

**Question.** When memory and archive both retain provenance, is stale-memory harm still primarily a verification-allocation failure? <!-- timefirst:question=isolate-stale-memory-harm-as-fixed-budget-verification-allocation -->

**Evidence.** At the same `k=2` verification budget, replacing one existing slot with the critical provenance path raises current-record-consistent decisions in superseded worlds by **61.3–74.0pp**, while valid-world outcomes move only **0–2.0pp** under the `same k2 budget`. <!-- timefirst:evidence=fixed-budget-critical-path-intervention-changes-later-decisions~same-k2-budget -->

**Caveat.** The forced-critical arm knows the oracle path and is a causal-identification instrument, not a deployable scheduler; real stores may require multi-hop authority resolution and unmeasured maintenance cost, leaving `deployable verification policy missing`. <!-- timefirst:caveat=oracle-critical-path-and-synthetic-provenance-store~deployable-verification-policy-missing -->

**Map.** `early_signal` — the study identifies allocation failure but does not yet supply a learned production verification policy.

**Links.** [Paper](https://arxiv.org/abs/2608.25553) · [中文深读](papers/2026/2608.25553.zh.md) · [English deep note](papers/2026/2608.25553.md)

</details>

<a id="entry-2608-25570"></a>
<details><summary><strong>2026-08-28 · KOPE</strong> · Execution-grounded Experience Graph Memory <!-- timefirst:area=execution-grounded-experience-graph --> — persists compile/test/profile outcomes as decision→outcome experience state and reuses it under a fixed context budget. <!-- timefirst:delta=discarded-tool-trajectories-to-persistent-execution-grounded-experience-state --></summary>

**Question.** With model parameters frozen, can persistent execution experience change later tool decisions while reducing context cost? <!-- timefirst:question=test-persistent-execution-experience-under-fixed-model-and-context-budget -->

**Evidence.** In the same GLM-5.2 workflow, the active-context ablation raises pass rate **60.0%→84.6%** while optimization tokens fall **15.9B→1.113B**; the Experience Graph Memory ablation raises full-suite pass rate **55.2%→84.6%** in the `fixed glm 5.2 workflow`. <!-- timefirst:evidence=same-workflow-experience-state-changes-pass-rate-and-context-cost~fixed-glm-5.2-workflow -->

**Caveat.** Active context jointly changes selection, compression, and injection; graph downstream-outcome score is a retrieval heuristic rather than a causal label, and `selection compression injection coupled` remains a component-level confound alongside unmatched construction/index/maintenance cost. <!-- timefirst:caveat=active-context-package-confound-and-incomplete-lifecycle-cost~selection-compression-injection-coupled -->

**Map.** `early_signal` — evidence supports execution-grounded external state, not attribution of the whole package gain to graph representation.

**Links.** [Paper](https://arxiv.org/abs/2608.25570) · [中文深读](papers/2026/2608.25570.zh.md) · [English deep note](papers/2026/2608.25570.md)

</details>

<a id="entry-2608-25655"></a>
<details><summary><strong>2026-08-28 · SCALE-QA / TSIM</strong> · Episode integrity reconstruction <!-- timefirst:area=episode-integrity-reconstruction --> — reconstructs coherent episodes from interleaved conversation before hierarchical retrieval and evidence assembly. <!-- timefirst:delta=turn-level-retrieval-to-episode-reconstruction-before-evidence-assembly --></summary>

**Question.** Do mixed-topic histories fail because similar turns are missed, or because episode localization/reconstruction fails before ordinary retrieval? <!-- timefirst:question=separate-episode-localization-from-ordinary-turn-level-retrieval -->

**Evidence.** Across three backends TSIM improves **5.6–17.6 accuracy points** over the strongest matched baseline; on the same flat history, pipeline accuracy progresses roughly **26.2→43.4→55.5→74.2** from standard RAG to fixed-token, semantic-drift, and full TSIM across `three backend matched settings`. <!-- timefirst:evidence=episode-reconstruction-package-improves-flat-interleaved-memory~three-backend-matched-settings -->

**Caveat.** Segmentation, deterministic summaries, hierarchy, and routing co-vary; SCALE-QA is a synthetic four-choice benchmark, and TSIM incurs materially higher ingest/retrieval overhead than standard RAG, so `full lifecycle cost must be matched`. <!-- timefirst:caveat=segmentation-summary-hierarchy-routing-package-and-synthetic-benchmark~full-lifecycle-cost-must-be-matched -->

**Map.** `early_signal` — episode integrity deserves a separate measurement boundary, but the package does not isolate which representation operation carries the gain.

**Links.** [Paper](https://arxiv.org/abs/2608.25655) · [中文深读](papers/2026/2608.25655.zh.md) · [English deep note](papers/2026/2608.25655.md)

</details>

<a id="entry-2608-26005"></a>
<details><summary><strong>2026-08-28 · VoiceMem</strong> · Streaming dual-brain memory <!-- timefirst:area=streaming-dual-brain-memory --> — gives factual/entity state and affect/persona state parallel streaming memory paths while keeping the upper organization/routing layer reusable across backends. <!-- timefirst:delta=single-text-memory-path-to-streaming-factual-and-affective-state-contracts --></summary>

**Question.** Should real-time multimodal memory use different state contracts for factual truth and persona/affect continuity? <!-- timefirst:question=test-separate-factual-and-affective-memory-contracts-under-streaming-budget -->

**Evidence.** Adding the same upper memory layer to Mem0, LangMem, and Zep raises their mean from **60.26→83.00 (+22.73pp)**; the top-5 operating point reports about **430 memory tokens / 134ms retrieval**, providing a `same upper layer transfer` witness. <!-- timefirst:evidence=portable-upper-memory-layer-improves-multiple-backends~same-upper-layer-transfer -->

**Caveat.** `134ms` is memory retrieval latency, not end-to-end conversational latency; asynchronous extraction/tagging/graph writes move cost off the critical path without matching backlog, energy, consistency, or deletion cost, leaving `full streaming lifecycle cost missing`. <!-- timefirst:caveat=retrieval-latency-not-end-to-end-and-async-write-cost-incomplete~full-streaming-lifecycle-cost-missing -->

**Map.** `early_signal` — dual-path organization has portability evidence, but component-level causal attribution remains package-confounded.

**Links.** [Paper](https://arxiv.org/abs/2608.26005) · [中文深读](papers/2026/2608.26005.zh.md) · [English deep note](papers/2026/2608.26005.md) · [Code](https://github.com/xzf-thu/VoiceMem)

</details>

<a id="entry-2608-24876"></a>
<details><summary><strong>2026-08-27 · Recuris</strong> · State-Grounded Memory Evolution <!-- timefirst:area=state-grounded-memory-evolution --> — Verified working state decides when persistent skills reach the actor, while structured traces localize later patches. <!-- timefirst:delta=standing-skill-library-to-state-grounded-localized-evolution --></summary>

**Question.** Does persistent skill-memory evolution add beyond matched skill availability, state/control, and retry budget? <!-- timefirst:question=separate-state-control-and-evolution-from-skill-availability-and-retries -->

**Evidence.** tau2-Retail is **58.1 Base / 82.0 WM-only / 65.6 same-library model-controlled / 83.6 Recuris**; the evolved package transfers GPT-5.6 Sol **58.33→76.10** and Claude Opus 5 **72.37→87.94**. <!-- timefirst:evidence=same-library-control-and-cross-model-transfer~same-library-model-controlled -->

**Caveat.** Terminal-Bench is only **58.6→60.9, p=.774** after matching four attempts; SkillFlow lacks a held-out task split, the dev gate is small, and `full evolution lifecycle cost is incomplete`. <!-- timefirst:caveat=retry-matched-null-and-incomplete-evolution-cost~full-evolution-lifecycle-cost-is-incomplete -->

**Map.** `early_signal` — One paper does not establish a durable self-evolving-memory direction.

**Links.** [Paper](https://arxiv.org/abs/2608.24876) · [中文深读](papers/2026/2608.24876.zh.md) · [English note](papers/2026/2608.24876.md) · [Code](https://github.com/Gen-Verse/Recuris)
...
- **`new_signal` · query conditioned storage use separation · RD-Forget · Storage and current-use authority should be evaluated separately.** Supports: [RD-Forget](#entry-2609-10263); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (separate-retention-from-query-local-admission): hold the source archive and reader fixed, then vary supersession/admission and destructive deletion independently. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="query-conditioned-storage-use-separation" state="new_signal" supports="2609.10263" confidence="medium" implication="separate-retention-from-query-local-admission" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · restore counterfactual eviction audit · What Eviction Destroys · Budget loss needs stage-local diagnosis before policy ranking.** Supports: [What Eviction Destroys](#entry-2609-08279); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (audit-eviction-retrieval-and-utilization-separately): report retrieval regime and use paired restoration to separate destroyed evidence, retrieval misses, and reader failures. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="restore-counterfactual-eviction-audit" state="new_signal" supports="2609.08279" confidence="medium" implication="audit-eviction-retrieval-and-utilization-separately" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · event structured posthoc compression · MemForest · Post-hoc store compression and retrieval recovery are separate interventions.** Supports: [MemForest](#entry-2609-08273); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (match-compression-and-read-policy-costs): compare equal compression ratios first, then vary AGPR separately and include merge/update maintenance cost. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="event-structured-posthoc-compression" state="new_signal" supports="2609.08273" confidence="medium" implication="match-compression-and-read-policy-costs" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->

<a id="last-30-days"></a>
### Last 30 days: 2026-08-13—2026-09-11

- **`new_signal` · query conditioned storage use separation · RD-Forget · Storage and current-use authority should be evaluated separately.** Supports: [RD-Forget](#entry-2609-10263); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (separate-retention-from-query-local-admission): hold the source archive and reader fixed, then vary supersession/admission and destructive deletion independently. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="query-conditioned-storage-use-separation" state="new_signal" supports="2609.10263" confidence="medium" implication="separate-retention-from-query-local-admission" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · restore counterfactual eviction audit · What Eviction Destroys · Budget loss needs stage-local diagnosis before policy ranking.** Supports: [What Eviction Destroys](#entry-2609-08279); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (audit-eviction-retrieval-and-utilization-separately): report retrieval regime and use paired restoration to separate destroyed evidence, retrieval misses, and reader failures. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="restore-counterfactual-eviction-audit" state="new_signal" supports="2609.08279" confidence="medium" implication="audit-eviction-retrieval-and-utilization-separately" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · event structured posthoc compression · MemForest · Post-hoc store compression and retrieval recovery are separate interventions.** Supports: [MemForest](#entry-2609-08273); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (match-compression-and-read-policy-costs): compare equal compression ratios first, then vary AGPR separately and include merge/update maintenance cost. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="event-structured-posthoc-compression" state="new_signal" supports="2609.08273" confidence="medium" implication="match-compression-and-read-policy-costs" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · provenance aware layered memory.** Supports: [2608.29606](#entry-2608-29606); confidence: **high**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (separate layered memory from retrieval interface and lifecycle cost): freeze reader / evidence surface / budget, then independently vary one store, provenance/citation lock, and routing while charging build, access, update, and maintenance cost. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="provenance-aware-layered-memory" state="new_signal" supports="2608.29606" confidence="high" implication="separate-layered-memory-from-retrieval-interface-and-lifecycle-cost" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · intervention calibrated memory credit.** Supports: [2608.29605](#entry-2608-29605); confidence: **high**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (separate entry presence utility from memory action causality): with scaffold / reader / budget fixed, distinguish whether an entry is necessary, the counterfactual value of the original memory action, and full supervision cost. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="intervention-calibrated-memory-credit" state="new_signal" supports="2608.29605" confidence="high" implication="separate-entry-presence-utility-from-memory-action-causality" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · personalized memory policy evolution: new early signal.** Supports: [2608.25329](#entry-2608-25329); confidence: **high**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (separate personalization policy from backbone and package): separate persona-specific policy state from backbone, distillation, and the RL package. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="personalized-memory-policy-evolution" state="new_signal" supports="2608.25329" confidence="high" implication="separate-personalization-policy-from-backbone-and-package" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · stale memory verification allocation: new early signal.** Supports: [2608.25553](#entry-2608-25553); confidence: **high**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (learn critical verification allocation under fixed budget): learn which belief needs a freshness check under a fixed audit budget instead of relying on an oracle path. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="stale-memory-verification-allocation" state="new_signal" supports="2608.25553" confidence="high" implication="learn-critical-verification-allocation-under-fixed-budget" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · execution grounded experience graph: new early signal.** Supports: [2608.25570](#entry-2608-25570); confidence: **high**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (isolate experience reuse from context packaging): freeze source experience and token budget, then separate graph relations, ranking, compression, and injection. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="execution-grounded-experience-graph" state="new_signal" supports="2608.25570" confidence="high" implication="isolate-experience-reuse-from-context-packaging" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · episode integrity reconstruction: new early signal.** Supports: [2608.25655](#entry-2608-25655); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (isolate episode reconstruction from hierarchy and summary): freeze evidence and context budget, then vary segmentation, summaries, hierarchy, and routing independently. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="episode-integrity-reconstruction" state="new_signal" supports="2608.25655" confidence="medium" implication="isolate-episode-reconstruction-from-hierarchy-and-summary" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · streaming dual brain memory: new early signal.** Supports: [2608.26005](#entry-2608-26005); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (measure streaming memory end to end lifecycle cost): measure factual/affective organization together with asynchronous write, retrieval, and end-to-end response cost. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="streaming-dual-brain-memory" state="new_signal" supports="2608.26005" confidence="medium" implication="measure-streaming-memory-end-to-end-lifecycle-cost" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · State grounded memory evolution.** Supports: [2608.24876](#entry-2608-24876); confidence: **high**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (separate state control invocation and evolution from retries): freeze the skill library and retry budget, then attribute working state, invocation, localized patches, and full evolution lifecycle cost separately. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="state-grounded-memory-evolution" state="new_signal" supports="2608.24876" confidence="high" implication="separate-state-control-invocation-and-evolution-from-retries" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Single interaction memory injection.** Supports: [2608.23471](#entry-2608-23471); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (measure joint retrieval and steering beside utility): match attack compute and report benign behavior. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="single-interaction-memory-injection" state="new_signal" supports="2608.23471" confidence="medium" implication="measure-joint-retrieval-and-steering-beside-utility" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Retrieval experience amortization.** Supports: [2608.22767](#entry-2608-22767); confidence: **low**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (test learned access on growing shuffled stores): include edit, delete, drift, and total maintenance cost. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="retrieval-experience-amortization" state="new_signal" supports="2608.22767" confidence="low" implication="test-learned-access-on-growing-shuffled-stores" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Constraint preserving compaction.** Supports: [2608.22752](#entry-2608-22752); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (match source aware compaction and retained tokens while charging classification and scope costs): charge classification, scope inference, and retained tokens. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="constraint-preserving-compaction" state="new_signal" supports="2608.22752" confidence="medium" implication="match-source-aware-compaction-and-retained-tokens-while-charging-classification-and-scope-costs" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Contrastive procedural memory.** Supports: [2608.22533](#entry-2608-22533); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (separate contrast from heterogeneous coverage): match source success diversity and full construction cost. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="contrastive-procedural-memory" state="new_signal" supports="2608.22533" confidence="medium" implication="separate-contrast-from-heterogeneous-coverage" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Skill validity boundaries.** Supports: [2608.22339](#entry-2608-22339); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (test skill boundaries under equal context): isolate boundary text, checker, repair, and failed-trajectory admission. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="skill-validity-boundaries" state="new_signal" supports="2608.22339" confidence="medium" implication="test-skill-boundaries-under-equal-context" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Persistent verifier governance.** Supports: [2608.21867](#entry-2608-21867); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (separate persistent verifier state from bundled lifecycle operations against a verifier only control): test the closest contrast directly. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="persistent-verifier-governance" state="new_signal" supports="2608.21867" confidence="medium" implication="separate-persistent-verifier-state-from-bundled-lifecycle-operations-against-a-verifier-only-control" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Provenance ranking utility frontier.** Supports: [2608.21230](#entry-2608-21230); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (measure poison rejection beside useful evidence retention): pair attack suppression with trusted and untrusted answer-evidence recall under matched context. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="provenance-ranking-utility-frontier" state="new_signal" supports="2608.21230" confidence="medium" implication="measure-poison-rejection-beside-useful-evidence-retention" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Executable memory hygiene.** Supports: [2608.20664](#entry-2608-20664); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (require later executable behavior and a strong verbatim control): match sleep compute before crediting typed consolidation. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="executable-memory-hygiene" state="new_signal" supports="2608.20664" confidence="medium" implication="require-later-executable-behavior-and-a-strong-verbatim-control" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Selection driven working memory.** Supports: [2608.20631](#entry-2608-20631); confidence: **low**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (separate active retention from long term persistence): isolate scoring, decay, folding, and suppression under token-matched controls. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="selection-driven-working-memory" state="new_signal" supports="2608.20631" confidence="low" implication="separate-active-retention-from-long-term-persistence" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Skill granularity transfer.** Supports: [2608.20274](#entry-2608-20274); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (match write units to the same later consumer): freeze source trajectories, actor, retrieval calls, and lifecycle cost before comparing task and subtask skills. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="skill-granularity-transfer" state="new_signal" supports="2608.20274" confidence="medium" implication="match-write-units-to-the-same-later-consumer" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Budgeted skill set selection.** Supports: [2608.19993](#entry-2608-19993); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (match selector supervision and full training cost): test complementarity on unfiltered tasks and charge outcome-data collection against saved context. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="budgeted-skill-set-selection" state="new_signal" supports="2608.19993" confidence="medium" implication="match-selector-supervision-and-full-training-cost" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Memory consumption harm makes applicability a post-retrieval decision.** Supports: [2608.20202](#entry-2608-20202); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (test useful retention beside trap rejection): use mixed memory-required, neutral, and adversarial workloads under matched context and lifecycle cost. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="memory-consumption-harm" state="new_signal" supports="2608.20202" confidence="medium" implication="test-useful-retention-beside-trap-rejection" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · State supersession resolution separates current state from retrieved history.** Supports: [2608.19652](#entry-2608-19652); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (separate persistent updates from answer time resolution): match ingestion and transcript access while independently varying retirement, dependency checks, and recomputation. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="state-supersession-resolution" state="new_signal" supports="2608.19652" confidence="medium" implication="separate-persistent-updates-from-answer-time-resolution" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Memory commitment governance precedes durable storage.** Supports: [2608.19564](#entry-2608-19564); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (execute commitment choices before claiming utility): run writes, checks, and clarification through later retrieval and task outcomes under authority-aware costs. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="memory-commitment-governance" state="new_signal" supports="2608.19564" confidence="medium" implication="execute-commitment-choices-before-claiming-utility" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Multi source evidence completion separates organization from access.** Supports: [2608.18704](#entry-2608-18704); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (separate organization from evidence completing access): attribute fused representation and answer-time search independently under matched lifecycle cost. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="multi-source-evidence-completion" state="new_signal" supports="2608.18704" confidence="medium" implication="separate-organization-from-evidence-completing-access" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Judge gate discriminability precedes persistent skill admission.** Supports: [2608.18719](#entry-2608-18719); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (qualify judge on candidate distribution): use within-question separation on genuine optimization traces before a judge controls commits. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="judge-gate-discriminability" state="new_signal" supports="2608.18719" confidence="medium" implication="qualify-judge-on-candidate-distribution" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Selector local credit makes skill access a learned stage.** Supports: [2608.18852](#entry-2608-18852); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (credit sparse memory actions locally): separate privileged selector supervision, loss masking, skill exposure, and downstream execution. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="selector-local-credit" state="new_signal" supports="2608.18852" confidence="medium" implication="credit-sparse-memory-actions-locally" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Guarded harness evolution treats commit as the continual-state boundary.** Supports: [2608.19013](#entry-2608-19013); confidence: **medium**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (guard harness state before commit): test current utility, historical retention, and validity while attributing each co-adaptive component separately. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="guarded-harness-evolution" state="new_signal" supports="2608.19013" confidence="medium" implication="guard-harness-state-before-commit" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
- **`new_signal` · Training side environment memory guides future curriculum generation.** Supports: [2608.19197](#entry-2608-19197); confidence: **low**; timing basis: `radar_published_at`; prior map evidence: `none`. Research-design implication (match retrieved training memory to static replay): compare retrieved history with token-matched static, random, and score-shuffled examples before crediting the memory policy. Exact synthesis time: `2026-09-11T00:43:34Z`. <!-- timefirst:direction key="training-side-environment-memory" state="new_signal" supports="2608.19197" confidence="low" implication="match-retrieved-training-memory-to-static-replay" timing="radar_published_at" synthesized="2026-09-11T00:43:34Z" prior="none" -->
