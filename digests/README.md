...
- **Weekly:** [2026-W32 — Structure only matters when control can use it](weekly/2026-W32.md). W33 (Aug 10–16) is still open at the current UTC+8 run time, so no closed-week compaction is due yet.
