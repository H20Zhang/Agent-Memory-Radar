...
| [Retrieval & Access](retrieval-access.md) | How should an agent locate, combine, and govern stored memory once representation is no longer flat? | **ReFind + RippleMem + Skill2Query + MESA/MAP-Graph:** raw-record search is a strong control, but structure can earn its cost through evidence completion, capability-grounded access, selective exposure, or admissibility. |
